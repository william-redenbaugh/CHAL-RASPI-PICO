...
{
    i2c_set_baudrate(map_i2c_fd(i2c->fd), freq_hz);
...
{
    int ret = i2c_write_blocking(map_i2c_fd(i2c->fd), addr, buf, size, false);
...
{
    int ret = i2c_read_blocking(map_i2c_fd(i2c->fd), addr, buf, size, false);
